          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const CurrencyCard(name: "Bitcoin", code: "BTC", amount: "9 785", icon: Icons.currency_bitcoin_rounded, isInverted: true, order: 2,),
                const CurrencyCard(name: "Dollar", code: "USE", amount: "428", icon: Icons.attach_money_outlined, isInverted: false, order: 3,),
              ],
            ),
          ),
        ),
